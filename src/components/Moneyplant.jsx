...
import manspec from "../assets/manspec.png";
  ...
  return (
    <div className="container">
      ...
      <div className="testimonial">
        ...
        <div className="testimonial-card">
          <div className="card-header">
            <img src={manspec} alt="Profile" className="testimonial-image" />
            <div>
          ...
          <p className="testimonial-text">
            ...
            industry. Today, I’m working as a full-stack developer with a salary
      ...
      <div className="donation">
        <img src={money} alt="Donation" className="donation-image" />
        <h3 className="donation-title">
          Empower Lives - Your Donation Matters
        </h3>
